...
ethernet_adapter_policies = {
  ...
  "MQ-SMBClient" = {
    ...
    enable_nvgre_offload                     = false
    enable_vxlan_offload                     = false
    description                              = "Recommended adapter settings for MultiQueue SMBClient"
    interrupt_coalescing_type                = "MIN"
    interrupt_mode                           = "MSIx"
    interrupt_timer                          = 125
    interrupts                               = 8
  ...
  "MQ-SMBServer" = {
    ...
    enable_nvgre_offload                     = false
    enable_vxlan_offload                     = false
    description                              = "Recommended adapter settings for MultiQueue SMBserver"
    interrupt_coalescing_type                = "MIN"
    interrupt_mode                           = "MSIx"
    interrupt_timer                          = 125
    interrupts                               = 8
  ...
  "VM-MultiQueue" = {
    ...
    enable_nvgre_offload                     = false
    enable_vxlan_offload                     = false
    description                              = "Recommended adapter settings for VM Multi Queue Connection"
    interrupt_coalescing_type                = "MIN"
    interrupt_mode                           = "MSIx"
    interrupt_timer                          = 125
    interrupts                               = 6
